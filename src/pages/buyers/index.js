...
export async function getServerSideProps(context) {
  ...
  const res = await fetch(
    `https://charlie-tango-case-git-main-mich4s74.vercel.app/api/find-buyers?zipCode=${context.query.zipCode}&price=${context.query.price}&estateType=${context.query.estateType}&size=${context.query.size}`
  );
